export const mockProjects = [
  ...
  {
    id: "mock-4",
    slug: "diseno-prototipo-sistema-bi-conversacional-apoyo-toma-decisiones-financieras-empresas-credito",
    titulo: "Diseño de un prototipo de sistema de BI conversacional para el apoyo en la toma de decisiones financieras en empresas de crédito",
    descripcion: "El presente trabajo tiene como objetivo diseñar un prototipo de sistema de inteligencia de negocios conversacional para optimizar la toma de decisiones en empresas de crédito, abordando la problemática crítica de la latencia en el procesamiento de datos y la dependencia de reportes manuales. Metodológicamente, el estudio se enmarca en la modalidad de Factible, con apoyo tecnológico y proyectiva. Para la fase de construcción del software, se adoptó la metodología ágil Extreme Programming (XP), lo que permitió un desarrollo iterativo centrado en la calidad del código, la simplicidad del diseño y la validación continua de los módulos funcionales. Como resultado, se determinaron los requerimientos técnicos y se integró una arquitectura que fusiona un motor de Procesamiento de Lenguaje Natural con un almacén de datos dimensional. El prototipo interpreta consultas financieras en español y genera visualizaciones automáticas de riesgo en tiempo real. Se proyecta que la herramienta reduzca significativamente los tiempos de análisis, facilitando una gestión de cartera proactiva mediante una interfaz intuitiva y eficiente.",
    carrera: "Ingeniería de Sistemas", carrera_id: "sistemas",
    semestre: "9no semestre", semestre_id: "9",
    ano_publicacion: "2025",
    sede: "Extensión Maracaibo", sede_id: "maracaibo",
    tipo: "Proyecto de Investigación", tipo_id: "Proyecto de Investigación",
    autores: ["Rubel Maneiro"], autor: "Rubel Maneiro",
    profesor: "Lic. Carmen Diáz, Ing. Roger Hau",
    ...
    archivos: [
      { nombre: "Proyecto de Investigación - DISEÑO DE UN PROTOTIPO DE SISTEMA DE BI CONVERSACIONAL.pdf", tipo: "pdf", peso: "1.1 MB", url: "https://drive.google.com/file/d/1Yt6-lDjrk744-I735vXKGpREFepjdVqL/view?usp=drivesdk" }
    ]
  },

  {
    id: "mock-5",
    slug: "diseno-centro-convenciones-exposiciones",
    titulo: "Diseño de Centro de Convenciones y Exposiciones",
    descripcion: "El presente proyecto arquitectónico propone la construcción de un Centro de Convenciones y Exposiciones en un terreno estratégico de Caracas, ubicado en la urbanización industrial Los Cortijos de Lourdes. Esta obra se erigirá como un hito cultural en la zona, delimitado por las avenidas Francisco de Miranda, Segunda Transversal, Alejandro Hernández y la quebrada Tocome. El programa funcional del centro se divide en dos grandes áreas: una norte, que alberga el teatro, talleres, servicios administrativos y un amplio foyer; y una sur, dedicada a salones de exposiciones, auditorio, cafetería y restaurante. Ambas zonas se conectan a través de un espacio central que actúa como núcleo de distribución y punto de encuentro.",
    carrera: "Arquitectura", carrera_id: "arquitectura",
    semestre: "7mo semestre", semestre_id: "7",
    ano_publicacion: "2025",
    sede: "Extensión Mérida", sede_id: "merida",
